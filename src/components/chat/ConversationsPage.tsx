    ...
    <div className="relative overflow-hidden">
      ...
      >
        <button
          ...
          className="w-full h-full flex flex-col items-center justify-center gap-1 text-white active:bg-gray-700 transition-colors"
        >
      ...
      >
        ...
        >
          ...
          {/* Chevron */}
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="w-4 h-4 text-gray-600 flex-shrink-0">
  ...
  return (
    ...
    >
      ...
      <div className="bg-[#111111] border-b border-white/8">
        ...
        >
          <h1 className="text-xl font-bold text-white">Диалоги</h1>
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        {!loading && safeConvs.length === 0 && (
          <div className="flex flex-col items-center justify-center h-64 px-8 text-center animate-fadeIn">
            ...
            <p className="text-white font-semibold text-base mb-2">Нет диалогов</p>
